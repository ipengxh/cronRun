...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="//cdn.bootcss.com/select2/3.5.4/select2-bootstrap.min.css">
  <link rel="stylesheet" type="text/css" href="//cdn.bootcss.com/select2/3.5.4/select2.min.css">
  <style>
    body {
  ...
  <!-- Scripts -->
  <script>
    window.CSRF = {!!json_encode(['csrfToken' => csrf_token()]) !!}
  </script>
</head>
<body>
